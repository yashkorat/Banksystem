...
<div id="dashboard">
    <div class="row">
        ...
        <span class="dlink"><br/>Details</span>
        </a> <a
        ...
        <object width="80px" height="80px"
                ...
                type="image/svg+xml"></object>
        <span class="dlink"><br/>Deposit</span>
    </a> <a
        ...
        <object width="80px" height="80px"
                ...
                type="image/svg+xml"></object>
        <span class="dlink"><br/>Withdraw</span>
    </a>
    </div>
    <div class="row">
        <a
        ...
        <object width="80px" height="80px"
                ...
                type="image/svg+xml"></object>
        <span class="dlink"><br/>Transaction
				History</span>
