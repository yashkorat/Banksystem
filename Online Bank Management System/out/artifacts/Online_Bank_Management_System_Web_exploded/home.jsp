...
<table width=100% height=100% border=0>
    <tr style="background-color:purple">
        <td colspan=2>
            <center>
                <a href="http://www.howstuffworks.com" target="_blank" alt="howstuffworks.com"><img src="hsw.gif"
                                                                                                    width=300 height=50></a>
                <a href="http://www.theserverside.com" target="_blank" alt="theserverside.com"><img src="logo.gif"
                                                                                                    width=300 height=50></a>
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <table cellpadding=5 style="font:700 12pt verdana">
                <tr>
                    <td>Your Account No :
                    <td>
                        <jsp:getProperty name="user" property="acno"/>
                </tr>
                <tr>
                    <td>Current Balance :
                    <td> <%= user.getBalance()%>
